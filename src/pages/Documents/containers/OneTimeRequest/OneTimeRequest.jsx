...
const OneTimeRequestContainer = ({ type }) => {
  ...
  const checkAllFieldsFilled = (newEntities) => {
    ...
    const contractListDocs = document.querySelector('.onetimerequest_fields__container');
    if (contractListDocs) {
  ...
  const handleGenerateOneTimeRequest  = async () => {
  ...
  return (
    <Container>
      ...
      <CustomButton
        ...
        onClick={handleGenerateOneTimeRequest}
        style={{
          width: '230px',
      ...
      <Container style={{ padding: '5px 10px 10px 10px', borderRadius: '6px' }}>
        ...
        <div className="onetimerequest_fields__container">
          {fields.map(field => (
