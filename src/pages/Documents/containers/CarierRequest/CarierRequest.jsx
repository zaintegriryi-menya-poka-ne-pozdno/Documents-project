...
const CarierRequestContainer = ({ type }) => {
  ...
  const checkAllFieldsFilled = (newEntities) => {
    ...
    const contractListDocs = document.querySelector('.carierrequest_fields__container');
    if (contractListDocs) {
  ...
  const handleGenerateCarierRequest = async () => {
  ...
  return (
    <Container>
      ...
      <CustomButton
        ...
        onClick={handleGenerateCarierRequest}
        style={{
          width: '230px',
      ...
      <Container style={{ padding: '5px 10px 10px 10px', borderRadius: '6px' }}>
        ...
        <div className="carierrequest_fields__container">
          {fields.map(field => (
